...
public interface Indexable<T>
{
	...
	// collection, where the front postion is logical index 0.  If the collection
	// has fewer than (i+1) items, throw an IndexOutOfBoundsException 
	public T getFront(int i);

	// Get and return the value located at logical location i from the back of the
	// collection, where the back postion is logical index 0.  If the collection
	// has fewer than (i+1) items, throw an IndexOutOfBoundsException 	
